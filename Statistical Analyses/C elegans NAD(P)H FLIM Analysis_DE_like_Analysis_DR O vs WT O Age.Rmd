...
```{r}
myages_g <- c("9")
data_mito_animal_matrix_al_yo_gg <- subset(data_mito_animal_matrix, Age%in%myages_g)

myvars_g <- c("Condition","g.a1","g.t1","g.t2","g.i","g.tm")
data_mito_animal_matrix_al_yo_g <- data_mito_animal_matrix_al_yo_gg[myvars_g]
...
write.table(Results_al_yo, file="stat summary wt o dr o.csv")
