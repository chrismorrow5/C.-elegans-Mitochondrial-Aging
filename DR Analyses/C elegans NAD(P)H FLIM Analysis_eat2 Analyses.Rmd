...
```{r}
set.seed(1)
myvars_mus <- c("t.bwm.a1","t.bwm.t1","t.bwm.t2","t.bwm.i","Age","Nutrients")
...
data_aldr_youngold_mus_pca_NAremov$t.bwm.a1 <- as.numeric(data_aldr_youngold_mus_pca_NAremov$t.bwm.a1)
data_aldr_youngold_mus_pca_NAremov$t.bwm.t1 <- as.numeric(data_aldr_youngold_mus_pca_NAremov$t.bwm.t1)
data_aldr_youngold_mus_pca_NAremov$t.bwm.t2 <- as.numeric(data_aldr_youngold_mus_pca_NAremov$t.bwm.t2)
data_aldr_youngold_mus_pca_NAremov$t.bwm.i <- as.numeric(data_aldr_youngold_mus_pca_NAremov$t.bwm.i)

data_aldr_youngold_mus_pca_NAremov$t.bwm.a1s <- as.numeric(scale(data_aldr_youngold_mus_pca_NAremov$t.bwm.a1))
data_aldr_youngold_mus_pca_NAremov$t.bwm.t1s <- as.numeric(scale(data_aldr_youngold_mus_pca_NAremov$t.bwm.t1))
data_aldr_youngold_mus_pca_NAremov$t.bwm.t2s <- as.numeric(scale(data_aldr_youngold_mus_pca_NAremov$t.bwm.t2))
data_aldr_youngold_mus_pca_NAremov$t.bwm.is <- as.numeric(scale(data_aldr_youngold_mus_pca_NAremov$t.bwm.i))

pca <- prcomp(data_aldr_youngold_mus_pca_NAremov[,7:10], scale=FALSE)
pcadatamus <- data.frame(pca$x[,1], pca$x[,2], Age=data_aldr_youngold_mus_pca_NAremov$Age, Nutrients=data_aldr_youngold_mus_pca_NAremov$Nutrients)

#pdf(paste(Sys.Date(),"bwm pca al dr y o.pdf"))
ggplot(pcadatamus, aes(x=pca$x[,1], y=pca$x[,2], col=Age, shape=Nutrients))+
  geom_point(size = 4)+
...
```{r}
set.seed(1)
myvars_pm <- c("pm.a1","pm.t1","pm.t2","pm.i","Age","Nutrients")
...
data_aldr_youngold_pm_pca_NAremov$pm.a1 <- as.numeric(data_aldr_youngold_pm_pca_NAremov$pm.a1)
data_aldr_youngold_pm_pca_NAremov$pm.t1 <- as.numeric(data_aldr_youngold_pm_pca_NAremov$pm.t1)
data_aldr_youngold_pm_pca_NAremov$pm.t2 <- as.numeric(data_aldr_youngold_pm_pca_NAremov$pm.t2)
data_aldr_youngold_pm_pca_NAremov$pm.i <- as.numeric(data_aldr_youngold_pm_pca_NAremov$pm.i)

data_aldr_youngold_pm_pca_NAremov$pm.a1s <- as.numeric(scale(data_aldr_youngold_pm_pca_NAremov$pm.a1))
data_aldr_youngold_pm_pca_NAremov$pm.t1s <- as.numeric(scale(data_aldr_youngold_pm_pca_NAremov$pm.t1))
data_aldr_youngold_pm_pca_NAremov$pm.t2s <- as.numeric(scale(data_aldr_youngold_pm_pca_NAremov$pm.t2))
data_aldr_youngold_pm_pca_NAremov$pm.is <- as.numeric(scale(data_aldr_youngold_pm_pca_NAremov$pm.i))

pca <- prcomp(data_aldr_youngold_pm_pca_NAremov[,7:10], scale=FALSE)
pcadatapm <- data.frame(pca$x[,1], pca$x[,2], Age=data_aldr_youngold_pm_pca_NAremov$Age, Nutrients=data_aldr_youngold_pm_pca_NAremov$Nutrients)

#pdf(paste(Sys.Date(),"pm pca al dr y o.pdf"))
ggplot(pcadatapm, aes(x=pca$x[,1], y=pca$x[,2], col=Age, shape=Nutrients))+
  geom_point(size = 4)+
  theme_classic(base_size = 30, base_family = "")+
  ylab(bquote("PC2"))+
  xlab(bquote("PC1"))+
...
```{r}
set.seed(1)
myvars_hyp <- c("t.h.a1","t.h.t1","t.h.t2","t.h.i","Age","Nutrients")
...
data_aldr_youngold_hyp_pca_NAremov$t.h.a1 <- as.numeric(data_aldr_youngold_hyp_pca_NAremov$t.h.a1)
data_aldr_youngold_hyp_pca_NAremov$t.h.t1 <- as.numeric(data_aldr_youngold_hyp_pca_NAremov$t.h.t1)
data_aldr_youngold_hyp_pca_NAremov$t.h.t2 <- as.numeric(data_aldr_youngold_hyp_pca_NAremov$t.h.t2)
data_aldr_youngold_hyp_pca_NAremov$t.h.i <- as.numeric(data_aldr_youngold_hyp_pca_NAremov$t.h.i)

data_aldr_youngold_hyp_pca_NAremov$t.h.a1s <- as.numeric(scale(data_aldr_youngold_hyp_pca_NAremov$t.h.a1))
data_aldr_youngold_hyp_pca_NAremov$t.h.t1s <- as.numeric(scale(data_aldr_youngold_hyp_pca_NAremov$t.h.t1))
data_aldr_youngold_hyp_pca_NAremov$t.h.t2s <- as.numeric(scale(data_aldr_youngold_hyp_pca_NAremov$t.h.t2))
data_aldr_youngold_hyp_pca_NAremov$t.h.is <- as.numeric(scale(data_aldr_youngold_hyp_pca_NAremov$t.h.i))

pca <- prcomp(data_aldr_youngold_hyp_pca_NAremov[,7:10], scale=FALSE)
pca.var <- pca$s#dev^2
pca.var.per <- round(pca.var/sum(pca.var)*100, 1)

pcadatahyp <- data.frame(pca$x[,1], pca$x[,2], Age=data_aldr_youngold_hyp_pca_NAremov$Age, Nutrients=data_aldr_youngold_hyp_pca_NAremov$Nutrients)

#pdf(paste(Sys.Date(),"hyp pca al dr y o.pdf"))
ggplot(pcadatahyp, aes(x=pca$x[,1], y=pca$x[,2], col=Age, shape=Nutrients))+
  geom_point(size = 4)+
  theme_classic(base_size = 30, base_family = "")+
  ylab(bquote("PC2"))+
  xlab(bquote("PC1"))+
