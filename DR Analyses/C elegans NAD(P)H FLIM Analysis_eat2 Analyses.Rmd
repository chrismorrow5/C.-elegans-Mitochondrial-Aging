...
setwd('C:/Users/cmorc/OneDrive - Harvard University/Projects/Metabolic Aging Atlas/Data Analysis/DR Analyses/')
...
pca <- prcomp(data_aldr_youngold_mus_pca_NAremov[,1:4], scale=TRUE)
pca.var <- pca$s#dev^2
...
pca <- prcomp(data_aldr_youngold_pm_pca_NAremov[,1:4], scale=TRUE)
pca.var <- pca$s#dev^2
pca.var.per <- round(pca.var/sum(pca.var)*100, 1)
...
pca <- prcomp(data_aldr_youngold_hyp_pca_NAremov[,1:4], scale=TRUE)
pca.var <- pca$s#dev^2
pca.var.per <- round(pca.var/sum(pca.var)*100, 1)
